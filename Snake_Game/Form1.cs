...
namespace Snake_Game
{
    public partial class Form1 : Form
    {
        ...
        private void updateGraphics(object sender, PaintEventArgs e)
        {
            ...
            Graphics canvas = e.Graphics; // create a new graphics class called cnavas
            ...
            if (Settings.GameOver == false)
            {
                ...
                for (int i = 0; i < Snake.Count; i++)
                {
                    if (i == 0)
                    {
                        // colour the head of the snake Light Coral
                        snakeColour = Brushes.LightCoral;
                    }
                    else
                    {
                        // the rest of teh body can be Misty Rose
                        snakeColour = Brushes.MistyRose;
                    }
        ...
        private void startGame()
        {
            ...
            label3.Visible = false; // set label 3 to invisble 
            ...
            generateFood(); // run generate food function
        }
        ...
        private void eat()
        {
            ...
            Settings.Score += Settings.Points; // increase the socre for the game
